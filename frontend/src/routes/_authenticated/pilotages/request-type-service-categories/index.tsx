...
function RouteComponent() {
  ...
  const { data: requestTypeServiceCategories } =
    useSuspenseQuery<RequestTypeServiceCategoryResponse>(
  ...
  const dataWithDelete = {
    ...
    data: (requestTypeServiceCategories.data ?? []).map(
  ...
  return (
    <>
      ...
      <DeleteModal
        ...
        deletePageName="request-type-service-categories"
        deleteId={deleteId}
        onSuccess={() => {
          setDeleteId(null);
          toast.success(
            SUCCESS_MESSAGES.delete(
              "Catégories de services par type de demande"
            )
          );
