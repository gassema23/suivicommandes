...
export const UnauthorizedPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="max-w-md w-full bg-background p-6 text-center">
        <div className="mb-4">
        ...
        <div className="space-x-2">
          <button
            ...
            className="bg-blue-600 hover:bg-primary text-white font-medium py-2 px-4 rounded-md transition-colors"
          >
            Retour
          </button>
          <button
