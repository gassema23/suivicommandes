...
export const Route = createFileRoute(
  ...
  beforeLoad: createPermissionGuard([PERMISSIONS.PROVIDER_SERVICE_CATEGORIES.CREATE]),
      head: () => ({
      ...
      staticData: {
        ...
        breadcrumb: [
          ...
          { label: "Fournisseurs par services", href: "/pilotages/provider-service-categories" },
          {
...
function RouteComponent() {
  return (
    <ProviderServiceCategoryCreateForm />
  )
}
