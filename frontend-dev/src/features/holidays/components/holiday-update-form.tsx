...
import { updateHoliday } from "../services/updateHoliday";
    ...
    const payload = {
      ...
      holidayDate:
        data.holidayDate instanceof Date
          ? data.holidayDate.toISOString().slice(0, 10) // format YYYY-MM-DD
          : data.holidayDate,
    };
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-12 gap-2 items-center">
        <Label className="col-span-12 xl:col-span-4">Jour férié</Label>
