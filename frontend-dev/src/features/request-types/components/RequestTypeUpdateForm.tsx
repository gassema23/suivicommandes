...
import { updateRequestType } from "../services/update-request-type.service";
...
export default function RequestTypeUpdateForm({ requestType }: RequestTypeFormProps) {
  ...
  const form = useForm<RequestTypeFormData>({
    ...
    defaultValues: {
      ...
      requestTypeDescription: requestType.requestTypeDescription ?? "",
    },
  });
  ...
  const updateMutation = useMutation({
    mutationFn: (data: RequestTypeFormData) =>
